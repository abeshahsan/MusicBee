...
public class FilePaths {
    public static final String SIGN_IN                = "/com/musicbee/musicbee/SignIn.fxml";
    public static final String SIGN_UP                = "/com/musicbee/musicbee/SignUp.fxml";
    public static final String HOME                   = "/com/musicbee/musicbee/Home.fxml";
    public static final String PLAYLIST_SCENE         = "/com/musicbee/musicbee/PlaylistScene.fxml";
    public static final String PROFILE                = "/com/musicbee/musicbee/Profile.fxml";
    public static final String EDIT_PROFILE           = "/com/musicbee/musicbee/EditProfile.fxml";
    public static final String SIDE_BAR               = "/com/musicbee/musicbee/Sidebar.fxml";
    public static final String CONTROL_PANEL          = "/com/musicbee/musicbee/ControlPanel.fxml";
    public static final String CHANGE_PWD             = "/com/musicbee/musicbee/ChangePwd.fxml";
    public static final String FORGOT_PASS_CHANGE_PWD = "/com/musicbee/musicbee/ForgotPassChangePwd.fxml";
